...
export function Hero() {
  return (
    <Container className="pb-16 pt-20 text-center lg:pt-32">
      <h1 className="mx-auto max-w-4xl font-display text-4xl font-medium tracking-tight text-secondary-900 sm:text-6xl">
        Fertilizantes{' '}
        <span className="relative whitespace-nowrap text-primary-600">
          ...
          <span className="relative">hechos simples</span>
        </span>{' '}
        para pequeñas empresas.
      </h1>
      <p className="mx-auto mt-6 max-w-2xl text-lg tracking-tight text-secondary-700">
      ...
      <div className="mt-10 flex justify-center gap-x-6">
        ...
        >
          ...
          <span className="ml-3">Ver Productos</span>
        </Button>
      </div>
      <div className="mt-36 lg:mt-44">
        <p className="font-display text-base text-secondary-900">
          Nuestras marcas
        </p>
        <ul
          role="list"
